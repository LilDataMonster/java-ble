...
class BlufiClientImpl2 implements BlufiParameter {
...
//    private int mConnectState = BluetoothGatt.STATE_DISCONNECTED;
    ...
    BlufiClientImpl2(BlufiClient client, BluetoothDevice device){
      mClient = client;
//      mContext = context;
      mDevice = device;
...
//        mUIHandler = new Handler(Looper.getMainLooper());
    ...
    BlufiClientImpl2(/*BlufiClient client, Context context, BluetoothDevice device*/) {
//        mClient = client;
//        mContext = context;
//        mDevice = device;
//        mInnerGattCallback = new InnerGattCallback();
